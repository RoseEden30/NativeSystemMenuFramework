...
| Expose a real ini setting the vanilla menu doesn't | [`GetIniSetting`/`SetIniSetting`](#getinisetting--setinisetting) |
...
to `0.0f` - a wrong name is a mod bug, not something to hide.
